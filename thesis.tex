...
\documentclass[11pt,twoside,final]{ucdthesis}
...
%% RP added margin control
\def\changemargin#1#2{\list{}{\rightmargin#2\leftmargin#1}\item[]}
\let\endchangemargin=\endlist 
%% RP force clear double page
...
\input{chapter1_introduction} %This looks for chapter1.tex
...
% chapter 3
%\chapter{Real Title Here}
\input{chapter3} %This looks for chapter3.tex
\input{appendix_ch3}
\printbibliography[heading=bibliography]

% chapter 4
%\chapter{Real Title Here}
\input{chapter4} %This looks for chapter4.tex
\input{appendix_ch4}
\printbibliography[heading=bibliography]

% chapter 5
%\chapter{Real Title Here}
\input{chapter5_conclusion} %This looks for chapter5_conclusion.tex
\printbibliography[heading=bibliography]
...
%\input{appendixCh3} %turned off SRM 05172020 to help compile quickly
%\printbibliography[heading=bibliography]
